...
class AddPayment extends Component {
    constructor(props) {
        ...
        this.amountEntered=this.amountEntered.bind(this);
    ...
    amountEntered(){
        this.openModal("输入金额",this.handleFromSubmit);
    }
    handleClick() {
        hashHistory.push("/purchasesPay");
        ...
        _modalID=Modal.open({
            ...
            content: (
                <Form onSubmit={handle}>
                    <FormControl name="footings" label={'结算总额：'} value={modal_data.footings} grid={5/6} placeholder="结算总额" required={true} tip={"请输入本次结算的总金额，系统会自动分配到各单据"}/>
                </Form>
            )
        })
    }
            ...
            <div>
                ...
                <div className="applySheet">
                    <div className="z_applyHd">
                        <div className="z_nav">
                            <span className="title">新增付款单</span>
                        </div>
                        <div className="backHistory">
                            <a href="javascript:;" onClick={this.handleClick.bind(this)}>返回采购付款</a>
                        </div>
                        <div className="z_nav_hd clearfix">
                            ...
                            <div className="hd_right">
                                <span className="title titleSheet">付款单号:</span>
                        ...
                        <Form onSubmit={this.formSubmit}>
                            <div>
                                <ul className="apply_hospital gap clearfix">
                                    ...
                                    <li className="second">
                                        <FormControl type="select" className="form-select hospital" name="payHospital" label={'往来单位：'} data={this.props.hospital_data}/>
                                    </li>
                                    <li className="last">
                                        <FormControl type="select" className="form-select time" name="clearTime" label={'付款日期：'} data={this.props.time}/>
                                    </li>
                                </ul>
                                <ul className="apply_hospital deal_money clearfix">
                                    ...
                                    <li className="button_input z_edge">
                                        <a onClick={this.amountEntered}>输入金额</a>
                                    </li>
                                    <li className="button_input z_edge">
