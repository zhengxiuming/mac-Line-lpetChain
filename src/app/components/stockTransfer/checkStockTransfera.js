/**
 * Created by zhengxiuming on 16/9/28.
 */
import React, {Component, PropTypes} from 'react';
import {Router, Route, hashHistory, Link} from 'react-router';
import {Table, Modal, FormControl, Form, Message, Datepicker, FormItem, Button, Icon,FormSubmit} from '../../libs/rctui/index';
...
class CheckStockTransferA extends Component {
    constructor(props) {
        super(props);
                ...
                <div className="applySheet">
                    ...
                    <div className="applySheetContent">
                        ...
                        <Form onSubmit={this.formSubmit}>
                            ...
                            <Button style={{marginRight:"65px"}} className="btn_search" status="primary" type="button">
                                取消调拨
                            </Button>
...
export default connect(mapStateToProps, mapDispatchToProps)(CheckStockTransferA)